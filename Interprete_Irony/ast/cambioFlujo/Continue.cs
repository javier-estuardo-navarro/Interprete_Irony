...
namespace Interprete_Irony.ast.cambioFlujo
{
     ...
     * @class   Continue
     *
     * @brief   Clase que representa a la sentencia de cambio de flujo Continue. 
     * 
     * No tiene acciones especificas ya que solo debemos saber su ubicacion y en las sentencias 
     * de control de flujo, realizar las acciones necesarias.
     *
